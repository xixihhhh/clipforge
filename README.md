...
- **✅ 合规 + 转化双开关**：**AIGC 双标识合规**——画面可一键烧「AI 生成」显式标识 + 成片自动写入隐式文件元数据（生成合成标签 / 服务提供者 / 内容制作编号，对齐国标 GB 45438-2025），躲开抖音/快手对「未标识 AI 内容」的自动限流；再加片尾「点击下方小黄车」购买 CTA，发布不违规、看完就下单。脚本页还有**发布前「限流自检」**：广告法风险词 / 钩子强度 / 时长甜区 / 字幕可读性 / 行动号召 / 带货三段式 逐项体检（✓⚠✗ + 具体改法，不打假分数），出片前一眼看出会不会被限流。
...
- **📈 效果回流（学出爆款）**：发布后在导出页回填这条的播放/点赞/成交，跨项目聚合出**哪种脚本风格、哪个开场钩子更能卖**，反哺后续生成——把「凭感觉」变成「用数据」。
...
| **多平台适配** | 手动调整比例/字幕 | 一键导出抖音/快手/小红书/TikTok/Reels/Shorts 版本 |
...
- **平台 SEO 优化**: 自动生成话题标签、封面文案、互动引导语，适配抖音/快手/小红书/TikTok/Reels/Shorts 算法
...
| **多平台导出** | 一条视频自动适配抖音/快手/TikTok/Reels/Shorts(9:16) 与小红书(3:4)规格，按平台命名导出 |
...
- [x] 多平台导出真实重编码（抖音 / 快手 / TikTok / Reels / Shorts 9:16、小红书 3:4，模糊填充）
